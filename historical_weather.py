...
end_time = pd.Timestamp.now().normalize() + pd.Timedelta(days=1) - pd.Timedelta(hours=1)  # "2026-03-31 23:00:00"
...
enriched_df.to_csv(f'data/weather/weather_hist_2026.csv', index=False)
